...
window.rtcMultiConnection = new RTCMultiConnection();
...
function addNewMessage(args) {
    ...
    userinfoDIV.style.background = args.color || this.rtcMultiConnection.extra.color || "#12f352";
