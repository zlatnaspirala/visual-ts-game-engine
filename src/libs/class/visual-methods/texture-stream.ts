 ...
 * Prepare for video stream texture
 * Type of stream textures will be
 * custum or any other canvas2D draw and video texture from
 * webRTC or local video camera or file.
 */
...
export default TextureStreamComponent;
